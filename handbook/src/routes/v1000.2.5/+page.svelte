...
<svelte:head>
	<title>Beacon v1000.2.5 — Lightweight reactive signals for Node.js backends</title>
	<meta
		name="description"
...
<div class="flex-1 flex flex-col items-center justify-center text-center px-4 py-10 lg:py-20 min-h-0 lg:min-h-[80vh] page-enter">
	...
	<div class="mb-2 flex items-center gap-1.5 flex-wrap justify-center">
		...
		<a href="https://www.npmjs.com/package/@nerdalytics/beacon/v/1000.2.5">
			<img src="https://flat.badgen.net/static/npm/v1000.2.5/blue" alt="npm v1000.2.5" />
		</a>
		<a href="https://socket.dev/npm/package/@nerdalytics/beacon/overview/1000.2.5">
			<img src="https://badge.socket.dev/npm/package/@nerdalytics/beacon/1000.2.5" alt="Socket" />
		</a>
	</div>
	...
	<a
		href={resolve('/v1000.2.5/introduction')}
